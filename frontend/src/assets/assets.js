...
import app_main_img from "./images/app_main_img.png";
...
import person_tick_icon from "./images/person_tick_icon.svg";
import play_store from "./images/play_store.svg";
import profile_img from "./images/profile_img.png";
import profile_upload_icon from "./images/profile_upload_icon.svg";
import management from "./images/project.png";
import resume_download_icon from "./images/resume_download_icon.svg";
import resume_not_selected from "./images/resume_not_selected.svg";
import resume_selected from "./images/resume_selected.svg";
import right_arrow_icon from "./images/right_arrow_icon.svg";
import samsung_logo from "./images/samsung_logo.png";
import search_icon from "./images/search_icon.svg";
import suitcase_icon from "./images/suitcase_icon.svg";
import twitter_icon from "./images/twitter_icon.svg";
import upload_area from "./images/upload_area.svg";
import walmart_logo from "./images/walmart_logo.svg";
import designing from "./images/web-design.png";
import work_1 from "./images/work-1.webp";
import work_2 from "./images/work-2.webp";
import work_3 from "./images/work-3.webp";
import upload_resume from "./images/upload-file.png";
...
export const faqs = [
  {
    ...
    title: "Terms",
    description1:
      "By accessing and using Superio, you agree to comply with our terms and conditions. Superio provides a platform to connect job seekers and employers, and all users are expected to use it responsibly and lawfully.",
    description2:
      "Users must ensure the accuracy of the information they provide. Superio reserves the right to remove content or suspend accounts that violate our policies or applicable laws.",
  },
  {
    id: 2,
    title: "Limitations",
    description1:
      "Superio does not guarantee employment to job seekers or hiring results to employers. The platform acts only as a medium to connect both parties.",
    description2:
      "We are not responsible for the accuracy of job postings, employer activities, or candidate information. Users are advised to verify details independently before making any decisions.",
  },
  {
    id: 3,
    title: "Revisions and Errata",
    description1:
      "The content on Superio, including job listings, company information, and resources, may include errors or outdated information. We do not warrant that all materials are completely accurate or current.",
    description2:
      "Superio may update, modify, or remove any content at any time without prior notice to ensure the platform remains accurate and relevant.",
  },
  {
    id: 4,
    title: "Site Terms of Use Modifications",
    description1:
      "Superio may revise these Terms of Use at any time without notice. By continuing to use the platform after updates, you agree to the modified terms.",
    description2:
      "We encourage users to review the Terms regularly to stay informed about any changes that may affect their usage of the platform.",
  },
];
